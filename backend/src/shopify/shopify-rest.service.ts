...
export class ShopifyRestService {
  ...
  async createCustomerInvite(
    ...
    const url = `https://${shop}/admin/api/2024-01/customers/${customerId}/send_invite.json`;
  ...
  async updateCustomerMetafields(
    ...
    const getUrl = `https://${shop}/admin/api/2024-01/customers/${customerId}/metafields.json`;
